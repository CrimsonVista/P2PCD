...
void MyVeinsApp::initialize(int stage) {
    ...
    printf("Initializing MyVeinsApp\n");
    if (stage == 0) {
...
void MyVeinsApp::handleSelfMsg(cMessage* msg) {
    ...
    printf("handleSelfMsg() MyVeinsApp\n");
